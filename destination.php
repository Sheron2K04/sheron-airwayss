<?php
// C:\xampp\htdocs\projectweb\sheronair\destinations.php
require_once __DIR__ . '/includes/config.php';
// (Optional: enable session + remember-me autologin if you want user-aware header)
        ...
        <div class="container mx-auto px-6 py-4">
            <div class="flex justify-between items-center">
                ...
                <nav class="hidden md:flex items-center space-x-6">
                    <a href="<?php echo BASE_URL; ?>/index.php" class="hover:text-blue-300 flex items-center">
                        <i class="fas fa-home mr-2"></i> Home
                    </a>
                    <a href="<?php echo BASE_URL; ?>/destinations.php"
                       class="text-blue-300 font-medium flex items-center">
                        <i class="fas fa-map-marked-alt mr-2"></i> Destinations
                    </a>
                    <a href="<?php echo BASE_URL; ?>/#about" class="hover:text-blue-300 flex items-center">
    ...
    <section class="bg-navy-800 py-20">
        <div class="container mx-auto px-4 text-center">
            ...
            <p class="text-xl text-blue-200 max-w-2xl mx-auto">
                Explore 15 breathtaking locations with Sheron Airlines' premium service
            </p>
        </div>
    </section>
        ...
        <div class="container mx-auto px-4">
            <div class="mb-12 text-center">
                ...
                <p class="text-blue-200 max-w-2xl mx-auto">
                    Select your dream destination and experience world-class travel
                </p>
            </div>

            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                <!-- Card template repeated 15x (images are external links you provided) -->
                <div class="destination-card rounded-xl overflow-hidden shadow-md border border-navy-700">
                    <div class="relative h-48">
                        <img src="https://www.carhire4lower.com/locations/france-paris/france-paris-images/paris.jpg"
                             alt="Paris" class="w-full h-full object-cover">
                    </div>
                    <div class="p-6">
                        <h3 class="text-xl font-bold mb-2">Paris, France</h3>
                        <p class="text-blue-200 mb-4">
                            Experience the romance of the City of Lights with iconic landmarks like the Eiffel Tower and Louvre Museum.
                        </p>
                        <div class="flex justify-between items-center">
                ...
                <div class="destination-card rounded-xl overflow-hidden shadow-md border border-navy-700">
                    <div class="relative h-48">
                        <img src="https://images.squarespace-cdn.com/content/v1/5b228bd689c172172ab88d9c/1501f7d6-87ac-445c-a87b-e9ff9551ccaa/_DSF5280-Enhanced-NR.jpg"
                ...
                <div class="destination-card rounded-xl overflow-hidden shadow-md border border-navy-700">
                    <div class="relative h-48">
                        <img src="https://res.cloudinary.com/picolo/image/fetch/f_webp,q_90,w_1600/https://res.cloudinary.com/picolo/image/upload/v1669217815/Picolo/City/Rome/First%2520time%2520in%2520Rome/Italy_Rome_Saint-Peters-Square_Travel_Picolo_Skyline_View.jpg"
                ...
                <div class="destination-card rounded-xl overflow-hidden shadow-md border border-navy-700">
                    <div class="relative h-48">
                        <img src="https://travelingseason.com/wp-content/uploads/2023/11/bali-indonesia.jpg"
                ...
                <div class="destination-card rounded-xl overflow-hidden shadow-md border border-navy-700">
                    <div class="relative h-48">
                        <img src="https://www.mustgo.com/wp-content/uploads/2018/06/shutterstock_1283691793.jpg"
                ...
                <div class="destination-card rounded-xl overflow-hidden shadow-md border border-navy-700">
                    <div class="relative h-48">
                        <img src="https://www.micato.com/wp-content/uploads/2018/09/cape-town-1-2.jpg"
                ...
                <div class="destination-card rounded-xl overflow-hidden shadow-md border border-navy-700">
                    <div class="relative h-48">
                        <img src="https://www.airpano.ru/files/dubai-uae/images/image1.jpg"
                ...
                <div class="destination-card rounded-xl overflow-hidden shadow-md border border-navy-700">
                    <div class="relative h-48">
                        <img src="https://www.agoda.com/wp-content/uploads/2024/04/Featured-image-Cathedral-of-the-Holy-Cross-and-Saint-Eulalia-Gothic-Quarter-Barcelona-Spain.jpg"
                ...
                <div class="destination-card rounded-xl overflow-hidden shadow-md border border-navy-700">
                    <div class="relative h-48">
                        <img src="https://i0.wp.com/picjumbo.com/wp-content/uploads/beautiful-venice-at-night-free-photo.jpg?w=2210&quality=70"
                ...
                <div class="destination-card rounded-xl overflow-hidden shadow-md border border-navy-700">
                    <div class="relative h-48">
                        <img src="https://photos.smugmug.com/Kyoto/Kyoto-Must-Do/i-JRJVg9N/0/f943b5ab/L/kyoto-must-do-shutterstock_403209976-L.jpg"
                ...
                <div class="destination-card rounded-xl overflow-hidden shadow-md border border-navy-700">
                    <div class="relative h-48">
                        <img src="https://www.beach.com/wp-content/uploads/2025/06/dreamstime_xxl_146011399-scaled.jpg"
                ...
                <div class="destination-card rounded-xl overflow-hidden shadow-md border border-navy-700">
                    <div class="relative h-48">
                        <img src="https://www.peru-explorer.com/wp-content/uploads/Peru-Machu-Picchu-tours-2025.jpg"
                ...
                <div class="destination-card rounded-xl overflow-hidden shadow-md border border-navy-700">
                    <div class="relative h-48">
                        <img src="https://www.apollocamper.co.nz/Portals/1/169614-queenstown-winter-web-1920px.jpg"
    ...
    <section class="py-16 bg-navy-800">
        <div class="container mx-auto px-4 text-center">
            ...
            <p class="text-xl text-blue-200 mb-8 max-w-2xl mx-auto">
                Join Sheron Airlines for an unforgettable travel experience
            </p>
            <a href="<?php echo BASE_URL; ?>/auth/signup.php"
               class="inline-block bg-blue-600 hover:bg-blue-700 text-white px-8 py-4 rounded-lg text-lg font-medium">
        ...
        <div class="container mx-auto px-4">
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                <div>
                    ...
                    <ul class="space-y-2">
                        <li>
                            <a href="<?php echo BASE_URL; ?>/index.php" class="text-blue-200 hover:text-white">
                                <i class="fas fa-home mr-2"></i> Home
                            </a>
                        </li>
                        <li>
                            <a href="<?php echo BASE_URL; ?>/destinations.php" class="text-blue-200 hover:text-white">
                                <i class="fas fa-map-marked-alt mr-2"></i> Destinations
                            </a>
                        </li>
                        <li>
                            <a href="<?php echo BASE_URL; ?>/#about" class="text-blue-200 hover:text-white">
            ...
            <div class="border-t border-navy-700 mt-12 pt-8 text-center text-blue-200">
                <p>&copy; <?php echo date('Y'); ?> Sheron Airlines. All rights reserved.</p>
            </div>
        </div>
    </footer>
</body>
